...
#ifndef DRAGONBALL_XIB_SWIFT_H
#define DRAGONBALL_XIB_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DragonBall_Xib",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14DragonBall_Xib11AppDelegate")
...
SWIFT_CLASS("_TtC14DragonBall_Xib25HeoresTableViewController")
@interface HeoresTableViewController : UITableViewController
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC14DragonBall_Xib20LogOutViewController")
@interface LogOutViewController : UIViewController
- (void)viewDidLoad;
- (IBAction)onLogOutTap:(id _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC14DragonBall_Xib13SceneDelegate")
...
SWIFT_CLASS("_TtC14DragonBall_Xib13TableViewCell")
...
SWIFT_CLASS("_TtC14DragonBall_Xib34TransformationsTableViewController")
@interface TransformationsTableViewController : UITableViewController
- (void)viewDidLoad;
- (NSInteger)numberOfSectionsInTableView:(UITableView * _Nonnull)tableView SWIFT_WARN_UNUSED_RESULT;
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
